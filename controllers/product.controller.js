...
const productsData = {
  ...
  const products = productsData.items.map(
    ({ id, name, description, features, price, keywords, url, category, subcategory, images }) =>
      new Product(id, name, description, features, price, keywords, url, category, subcategory, images)
  );

  try {
    await Product.insertManyProducts(products);
